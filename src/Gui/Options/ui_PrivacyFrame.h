...
public:
    ...
    void retranslateUi(QFrame *PrivacyFrame)
    {
        ...
        m_newsCheck->setText(QApplication::translate("PrivacyFrame", "I want to see bitcoin2network Blog feeds", 0));
        m_embeddedHelperLabel->setText(QApplication::translate("PrivacyFrame", "Checking this box will result in updated Overview screen. It will now show you the latest posts of bitcoin2network Blog providing you with fresh bitcoin2network news.", 0));
    } // retranslateUi
