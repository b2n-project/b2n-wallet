...
public:
    ...
    void retranslateUi(QFrame *ConnectionOptionsFrame)
    {
        ...
        m_autoHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to local bitcoin2network daemon process on port 19635. In case of no local daemon running it will use an in-wallet embedded node implementation.", 0));
        m_embeddedRadio->setText(QApplication::translate("ConnectionOptionsFrame", "Embedded", 0));
        m_embeddedHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "An in-wallet embedded bitcoin2network node will be used.", 0));
        ...
        m_localHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to local bitcoin2network daemon process. Please specify daemon's port.", 0));
        ...
        m_remoteHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to bitcoin2network node running on another PC in the local or global network. Please specify IP address or domain name and the port.", 0));
    } // retranslateUi
