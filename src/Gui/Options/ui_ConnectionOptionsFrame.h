...
public:
    ...
    void retranslateUi(QFrame *ConnectionOptionsFrame)
    {
        ...
        m_autoHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to local bitcoin2network daemon process on port 32367. In case of no local daemon running it will use an in-wallet embedded node implementation.", 0));
