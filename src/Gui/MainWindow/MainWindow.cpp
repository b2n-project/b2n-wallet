...
const char COMMUNITY_FORUM_URL[] = "https://blog.bitcoin2.network";
const char REPORT_ISSUE_URL[] = "http://support.bitcoin2.network";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
//  setWindowTitle(tr("bitcoin2network Wallet %1").arg(Settings::instance().getVersion()));
