...
public:
    ...
    QAction *m_aboutbitcoin2networkAction;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/bitcoin2network"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutbitcoin2networkAction = new QAction(MainWindow);
        m_aboutbitcoin2networkAction->setObjectName(QStringLiteral("m_aboutbitcoin2networkAction"));
        m_aboutbitcoin2networkAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutbitcoin2networkAction);
        ...
        QObject::connect(m_aboutbitcoin2networkAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutbitcoin2networkAction->setText(QApplication::translate("MainWindow", "About bitcoin2network", 0));
        ...
        m_walletLabel->setText(QApplication::translate("MainWindow", "Your bitcoin2network wallet:", 0));
#ifndef QT_NO_TOOLTIP
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND MARKETCASH", 0));
